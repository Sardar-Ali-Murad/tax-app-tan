...
const FormCard = ({ routes, setCount }) => {
  return (
    <div className="card-positioning-wrap">
      ...
      <div className="main-card-wrap" style={{ background: "#C4C4C4" }}>
        <div className="d-flex final-form-header">
        ...
        <div>
          ...
          <div className="expense-input-wrap">
            <div
              className="final-form-input-main-wrap"
        ...
        <div className="card-button-wrap mt-40">
          <button className="back" onClick={() => setCount(4)}>Back</button>
          <button className="next-btn active-color" onClick={() => setCount(1)}>
            <p>Next</p>
            <img src={buttonArrow} />
          </button>{" "}
        </div>
